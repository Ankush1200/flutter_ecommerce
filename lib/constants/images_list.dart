...
// Featured categories images list
List featuredImages1=[imgS1,imgS2,imgS3];
List featuredImages2=[imgS4,imgS5,imgS6];
List featuredTitle1=[womenDress,girlsDress,girlsWatches];
List featuredTitle2=[boysGlasses,mobilePhone,tShirts];


// Featured Product Images List
List featuredProductsImages=[imgP1,imgP2,imgP3,imgP4,imgP5];
List featuredProductsNames=["Hp Victus(8/512)","Makup Kit","Macbook Air M1","Weston Shooes","Bag-5L(2 in 1)"];
List featuredProductsPrice=["₹64,999","₹5999","₹78,949","₹499","₹599"];
